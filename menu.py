...
def order(page: int, max_page: int):
    ...
    button_3 = types.InlineKeyboardButton('◀️  Пред. страница', callback_data='u_order' + str(page - 1))
    button_4 = types.InlineKeyboardButton('След. страница  ▶️', callback_data='u_order' + str(page + 1))
    if page <= 1:
